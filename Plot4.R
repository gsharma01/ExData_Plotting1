...
#1st 
plot(requiredData$globalActivePower, type="l",xaxt="n",xlab="", ylab="Global Active Power")
axis(1, at=c(1, as.integer(nrow(requiredData)/2), nrow(requiredData)), labels=c("Thu", "Fri", "Sat"))

#2nd
plot(requiredData$voltage, type="l",xaxt="n",xlab="datetime", ylab="Voltage")
axis(1, at=c(1, as.integer(nrow(requiredData)/2), nrow(requiredData)), labels=c("Thu", "Fri", "Sat"))
...
#4th
plot(requiredData$globalReactivePower, type="l",xaxt="n",xlab="datetime", ylab="Global_reactive_power")
axis(1, at=c(1, as.integer(nrow(requiredData)/2), nrow(requiredData)), labels=c("Thu", "Fri", "Sat"))
